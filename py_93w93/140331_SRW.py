...
#np.savetxt('data/93w93_npk_srw_sum_A0.txt',sum_A0)
#np.savetxt('data/93w93_npk_srw_sum_A2.txt',sum_A2)
#np.savetxt('data/93w93_npk_srw_Ls.txt',Ls)

np.savetxt('data/93w93_pk_srw_sum_A0.txt',sum_A0)
np.savetxt('data/93w93_pk_srw_sum_A2.txt',sum_A2)
np.savetxt('data/93w93_pk_srw_Ls.txt',Ls)
# Plots
...
pl.title(title('9','3','RR, perpendicular'))
pl.legend(loc = 'best')
#pl.savefig(svfig('93','93_npk','loglog, perpendicular'))
pl.savefig(svfig('93','93_pk','RR_loglog, perpendicular'))
pl.show()
