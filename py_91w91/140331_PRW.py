...
#np.savetxt('data/91w91_npk_A_parallel_ret.txt',sum_A)
#np.savetxt('data/91w91_npk_Lengths_parallel_ret.txt',Ls)

np.savetxt('data/91w91_pk_A_parallel_ret.txt',sum_A)
np.savetxt('data/91w91_pk_Lengths_parallel_ret.txt',Ls)
# PLOTS
...
pl.title(title('6','5','RR, parallel'))
pl.legend(loc = 'best')
#pl.savefig(svfig('91','91_npk_','loglog_parallel'))
pl.savefig(svfig('91','91','RR_loglog_parallel'))
pl.show()
