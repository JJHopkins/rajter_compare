...
Ls = np.arange(1e-10,1e-9,1e-10)  # separation distance between 2 cyclinders
...
#np.savetxt('data/65w65_npk_srw_sum_A0.txt',sum_A0)
#np.savetxt('data/65w65_npk_srw_sum_A2.txt',sum_A2)
#np.savetxt('data/65w65_npk_srw_Ls.txt',Ls)

np.savetxt('data/65w65_pk_srw_sum_A0.txt',sum_A0)
np.savetxt('data/65w65_pk_srw_sum_A2.txt',sum_A2)
np.savetxt('data/65w65_pk_srw_Ls.txt',Ls)
# Plots
...
pl.title(title('9','1','RR, perpendicular'))
pl.legend(loc = 'best')
#pl.savefig(svfig('91','91_npk','loglog, perpendicular'))
pl.savefig(svfig('91','91_pk','RR_loglog, perpendicular'))
pl.show()
