...
Ls = np.arange(1e-9,151e-9,10e-9)  # separation distance between 2 cyclinders
t  = np.linspace(0.,200,201)#,100)
u  = np.linspace(0.,200,201)#,99) 
y  = np.linspace((1.+1e-5),201,201)#,98)
y0 = np.linspace((1.+1e-5),201,201)#,98)
...
np.savetxt('91w91_prw_sum_A_mvsum.txt',sum_A)
np.savetxt('91w91_prw_Ls_mvsum.txt',Ls)
