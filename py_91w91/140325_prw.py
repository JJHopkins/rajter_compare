...
Ls = np.arange(1e-9,500e-9,1e-9)  # separation distance between 2 cyclinders
...
#Integration vars
t  = np.linspace(0.,2.**7, 1.+2.**7)
u  = np.linspace(0.,2.**7, 1.+2.**7)
y  = np.linspace((1.+1e-5),2.**7, 1.+2.**7)
y0 = np.linspace((1.+1e-5),2.**7, 1.+2.**7)
...
pl.savefig(svfig('91','91','parallel'))
pl.legend(loc = 'best')
pl.show()
#
