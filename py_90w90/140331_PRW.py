...
np.savetxt('data/93w93_npk_A_parallel_ret.txt',sum_A)
np.savetxt('data/93w93_npk_Lengths_parallel_ret.txt',Ls)

#np.savetxt('data/93w93_pk_A_parallel_ret.txt',sum_A)
#np.savetxt('data/93w93_pk_Lengths_parallel_ret.txt',Ls)
# PLOTS
...
pl.xlabel(x_ax)
pl.ylabel(y_ax_par)
pl.title(title('9','3','parallel'))
#pl.title(title('9','3','RR, parallel'))
pl.legend(loc = 'best')
pl.savefig(svfig('93','93_npk_','loglog_parallel'))
#pl.savefig(svfig('93','93','RR_loglog_parallel'))
pl.show()
...
#pl.savefig(svfig('91','91_npk_','parallel'))
#pl.legend(loc = 'best')
#pl.show()
