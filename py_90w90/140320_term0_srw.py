...
np.savetxt('90w90_srw_sum_A0.txt',sum_A0)
np.savetxt('90w90_srw_sum_A2.txt',sum_A2)
np.savetxt('90w90_srw_Ls.txt',Ls)

pl.figure()
pl.loglog(Ls,sum_A0,label=r'$\mathcal{A^{(0)}}(\ell=%1.1f nm)=%3.2f\,\,\,\
        mathcal{A^{(0)}}(\ell=%1.1f nm)=%3.2f$'%(1e9*Ls[0],1e21*sum_A0[0],1e9*Ls[1],1e21*sum_A0[1]))
pl.loglog(Ls,sum_A2,label=r'$\mathcal{A^{(2)}}(\ell=%1.1f
        nm)=%3.2f\,\,\,\mathcal{A^{(2)}}(\ell=%1.1f nm)=%3.2f$'%(1e9*Ls[0],1e21*sum_A2[0],1e9*Ls[3],1e21*sum_A2[3]))
pl.legend(loc = 'best')
pl.show()
