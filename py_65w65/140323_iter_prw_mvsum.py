...
#Ls = np.arange(1e-9,100e-9,10e-9)  # separation distance between 2 cyclinders
##Ls = np.arange(1.e-9,1.e-6,10e-9) #np.linspace(1.0e-9, 1.0e-6, 20) # separation distance between 2 cyclinders
#t = np.linspace(0.,1e5,3e2)
#u = np.linspace(0.,1e5,3e2) 
##u = np.linspace(0.,1e4,1e4) 
#y = np.linspace(1.000001,100001.000001,3e2)
...
#u = np.linspace(0.,1e4,1e4) 
y = np.linspace(1.000001,1001.000001,1e3)
